 ...
 */
export function calculateScores(questions: QuestionData[]): ScoreResult {
  let totalFfp = 0;
  let totalSbp = 0;
 ...
 */
function compareAnswers(user: string | null, good: string | null): boolean {
  if (good === null || good === undefined) return false;
